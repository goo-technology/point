...
uint256 hashGenesisBlock("0xdd1831fe399074f8238ffcbf6396e07d9f4e8f1b0d69c60bd69ec13c3eaa7f9c");
...
{
	int64 blockNumber = (int64)nHeight;
	int64 divider = 100000.0;
	int64 nSubsidy = blockNumber/divider * COIN;
	return nSubsidy + nFees;

}

static const int64 nTargetTimespan = 1 * 60; // pointcoin: 1 minute
static const int64 nTargetSpacing = 1 * 15; // pointcoin: 15 seconds blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal pointcoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x090b6f4a076906996b3a34a1d44459664bfccb79f7004e54b02a7f88f1f34dcc");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1478902744; //epochtime
